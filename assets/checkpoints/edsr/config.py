...
default_hooks = dict(
    checkpoint=dict(
        ...
        max_keep_ckpts=2,
        out_dir=
        '/home/featurize/out/AI6126project2/edsr/edsr_iter300000_psMULTISTEP_opAdam_daPRC_FlipH_FlipV_RT_nTrue',
        rule='greater',
        save_best='PSNR',
        save_optimizer=True,
        type='CheckpointHook'),
...
experiment_name = 'edsr_iter300000_psMULTISTEP_opAdam_daPRC_FlipH_FlipV_RT_nTrue'
gt_h_size = 512
gt_w_size = 512
launcher = 'none'
load_from = None
...
resume = False
save_dir = '/home/featurize/out/AI6126project2/edsr/edsr_iter300000_psMULTISTEP_opAdam_daPRC_FlipH_FlipV_RT_nTrue'
scale = 4
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            ...
            name=
            'edsr_iter300000_psMULTISTEP_opAdam_daPRC_FlipH_FlipV_RT_nTrue',
...
work_dir = '/home/featurize/out/AI6126project2/edsr/edsr_iter300000_psMULTISTEP_opAdam_daPRC_FlipH_FlipV_RT_nTrue'
