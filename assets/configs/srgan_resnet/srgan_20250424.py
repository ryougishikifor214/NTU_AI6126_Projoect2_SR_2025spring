...
experiment_name = 'srgan_iter400000_psMULTISTEP_opMultiOptimWrapperConstructor_daPRC_FlipH_FlipV_RT_Cutblur_nTrue'
gt_h_size = 512
gt_w_size = 512
load_from = None
log_level = 'INFO'
...
param_scheduler = dict(
    ...
    type='MultiStepLR')
resume = False
save_dir = '/home/featurize/out/AI6126project2/srgan_resnet/srgan_iter400000_psMULTISTEP_opMultiOptimWrapperConstructor_daPRC_FlipH_FlipV_RT_Cutblur_nTrue'
scale = 4
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(dictionary=dict(scale=1), type='SetValues'),
            dict(
                keys=[
                    'img',
                ],
            ...
            dict(params=dict(alpha=0.7), type='Cutblur'),
            dict(keys=[
                'img',
                'gt',
            ], type='PackInputs'),
...
work_dir = '/home/featurize/out/AI6126project2/srgan_resnet/srgan_iter400000_psMULTISTEP_opMultiOptimWrapperConstructor_daPRC_FlipH_FlipV_RT_Cutblur_nTrue'
